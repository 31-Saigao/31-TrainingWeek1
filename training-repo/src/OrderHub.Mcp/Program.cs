...
// stdout is the MCP protocol channel — all logs must go to stderr instead
...
// Same layering as OrderHub.Web: tools go through service/repository, never touch DbContext directly
